...
class ClientAgent(BaseAgent):
    """
    A client-focused agent that provides information about services, pricing, 
    project details, and business processes.
    """
    
    def __init__(self):
        """Initializes the ClientAgent with predefined services and processes."""
        super().__init__(
            name="BusinessAdvisor",
            description=(
                "I'm the client specialist. I can provide information about "
                "services, pricing, and project details."
            ),
    ...
    def get_services_overview(self):
        """Generates an overview of available services formatted in markdown."""
    ...
    def get_service_details(self, service_id):
        """Generates detailed information about a specific service."""
    ...
    def explain_process(self):
        """Explains the client engagement process in markdown format."""
    ...
    def generate_proposal(self, project_description):
        """Generates a professional project proposal based on client requirements."""
        prompt = f"""
    ...
    def get_pricing(self, service_id):
        """Retrieves pricing details for a specific service."""
        return self.get_service_details(service_id)

    def get_project_timeline(self, service_id):
        """Retrieves the estimated timeline for a specific service."""
        return self.get_service_details(service_id)
